...
# Class icm.dialog.casepackagedialog.CasePackageDialog
...
Defined in:  <icm\dialog\casepackagedialog\CasePackageDialog.js>.
...
|                     | afterDownload()                                                                                                                                                  |
|                     | constructor()                                                                                                                                                    |
|                     | createCasePackageJSON(reviewPackageJson, casePropsJson, systemPropsJson, relatedCaseJson, docInfoJson, caseInfo)                                                 |
|                     | createCommentsCheckboxTree()                                                                                                                                     |
|                     | createOffset(date)                                                                                                                                               |
|                     | deletePreviewPDF(screenData, originalData)                                                                                                                       |
|                     | generatePDF(callback, errCallback, backgroundRequest)                                                                                                            |
|                     | generatePDFNewWindow(callback, errCallback, backgroundRequest)                                                                                                   |
|                     | generateZIP(callback, errCallback, backgroundRequest)                                                                                                            |
|                     | getCaseInfoJson(caseCommentsEnabled, docCommentsEnabled, taskCommentsEnabled, workitemCommentsEnabled, caseHistoryEnabled, caseEventsEnabled, caseStagesEnabled) |
|                     | getDocumentsJson()                                                                                                                                               |
|                     | getDocumentsJsonNoWizard()                                                                                                                                       |
|                     | getReviewPackageJson()                                                                                                                                           |
|                     | goNext()                                                                                                                                                         |
|                     | goPrevious()                                                                                                                                                     |
|                     | hideWaitingDialog()                                                                                                                                              |
|                     | onAdd(screenData)                                                                                                                                                |
...
|                     | postCreate()                                                                                                                                                     |
|                     | renderCaseDocuments()                                                                                                                                            |
|                     | renderCaseProperties()                                                                                                                                           |
|                     | renderRelatedCases(callback)                                                                                                                                     |
|                     | renderReviewPackage()                                                                                                                                            |
|                     | requestFailedCallbackDialog(errorResponse)                                                                                                                       |
|                     | resize()                                                                                                                                                         |
|                     | setOneClickEditPane()                                                                                                                                            |
|                     | setWidgets(, , payload, action, noWizard, callback) 								 Shows the dialog and the initialise the classes/module widgets within the dialog                    |
|                     | show()                                                                                                                                                           |
|                     | showWaitingDialog()                                                                                                                                              |
|                     | startDownload(itemList)                                                                                                                                          |
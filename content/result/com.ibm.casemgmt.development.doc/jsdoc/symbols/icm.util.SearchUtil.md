...
# Class icm.util.SearchUtil

Helper class to create the search payload used between CaseSearch widget and CaseList widget.
Here is sample of how this class should be used:

Defined in:  <icm\util\SearchUtil.js>.
...
|---------------------|-------------------------------------------------------------------------------------------------------------------------|
|                     | constructor()                                                                                                           |
|                     | createSearchCriterionModel(attDef, format, operators, selectedOperator, values) 								 get the search criterion model |
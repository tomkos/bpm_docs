...
# Class icm.action.document.AddDocumentFromOtherApplication
...
Defined in:  <icm\action\document\AddDocumentFromOtherApplication.js>.
...
|                     | init()                                                                                                                                                                        |
|                     | isVisible()                                                                                                                                                                   |
|                     | showAddContentItemDialog(repository, parentFolder, typeDocument, virtualItems, callback, teamspace, useTemplate, entryTemplate, showMultiRepoFolderSelector, repositoryTypes) |
...
COPYRIGHT
    - Method Summary Methods Modifier and Type Method and Description RuleBlock getParentRuleBlock () Get the rule block that contains this rule.

### Method Summary

| Modifier and Type   | Method and Description                                           |
|---------------------|------------------------------------------------------------------|
| RuleBlock           | getParentRuleBlock() Get the rule block that contains this rule. |

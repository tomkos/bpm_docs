...
# Class icm.pgwidget.caseinfo.dijit.header.CaseInfoHeader
...
|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------|
|                          | icm.pgwidget.caseinfo.dijit.header.CaseInfoHeader() 							 ContentPane class that represents a tab component used in Case Information widget. |

| Method Attributes   | Method Name and Description                                                       |
|---------------------|-----------------------------------------------------------------------------------|
|                     | constructor() 								 Widget attributes propagated from Case Information widget. |
|                     | destroy()                                                                         |
|                     | hide() 								 Hide header                                                       |
|                     | onClickOpenCaseDetails() 								 Event fired when case ID is clicked.            |
|                     | onMouseOutOpenCaseDetails()                                                       |
|                     | onMouseOverOpenCaseDetails()                                                      |
|                     | reset() 								 Reset the case Id on the header                                  |
|                     | setCaseId(caseId, bCanOpen) 								 Set case identifier on the header            |
|                     | show() 								 Show header                                                       |
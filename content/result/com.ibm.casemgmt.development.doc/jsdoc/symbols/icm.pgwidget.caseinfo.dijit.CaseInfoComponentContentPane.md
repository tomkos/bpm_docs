...
|--------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------|
|                          | icm.pgwidget.caseinfo.dijit.CaseInfoComponentContentPane() 							 ContentPane class that represents a tab component used in Case Information widget. |

| Field Attributes   | Field Name and Description                                                   |
|--------------------|------------------------------------------------------------------------------|
|                    | widgetProperties  Widget attributes propagated from Case Information widget. |

| Method Attributes   | Method Name and Description                              |
|---------------------|----------------------------------------------------------|
|                     | destroy()                                                |
|                     | getContext()                                             |
|                     | isInFocus() 								 Check if this widget is in focus    |
|                     | onClickTab() 								 Handler for tab clicked event.     |
|                     | postCreate()                                             |
|                     | render() 								 Render widget content.                 |
|                     | resetRender() 								 Reset render data.                |
|                     | resize() 								 Resize function                        |
|                     | setContext(context) 								 Set context.                |
|                     | setModel(model) 								 Set model for the widget        |
|                     | setParentWidet(parentWidget) 								 Set parent widget. |

- model: The case information data required by the
           widget.
...
Extends
					icm.pgwidget.caseselectdocument.dijit.CaseSelectDocumentContentPane, icm.base.BasePageWidget.
...
|---------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | handleICM\_ClearContentEvent() 								 Handler for the icm.ClearContent event which can be used to clear the content in the  Select Case Document widget.                    |
|                     | handleICM\_ClearSelectedDocEvent() 								 Handler for the icm.ClearSelectedDoc event which can be used to clear the selected documents in the  Select Case Document widget. |

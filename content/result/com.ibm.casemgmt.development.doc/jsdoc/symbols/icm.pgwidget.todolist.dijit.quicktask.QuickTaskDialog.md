...
# Class icm.pgwidget.todolist.dijit.quicktask.QuickTaskDialog
...
Defined in:  <icm\pgwidget\todolist\dijit\quicktask\QuickTaskDialog.js>.
...
|---------------------|------------------------------------------------------------------------------|
|                     | addAttachmentsFromCase()                                                     |
|                     | addAttachmentsFromLocal()                                                    |
|                     | clean()                                                                      |
|                     | constructor()                                                                |
|                     | deleteQuickTask()                                                            |
|                     | disableRightClick(e) 								 disables right click on quick task title icons |
|                     | hide()                                                                       |
|                     | initializeAttachmentButton()                                                 |
|                     | initializeAttachments(self)                                                  |
|                     | isMaxim()                                                                    |
|                     | isUserAssignee()                                                             |
|                     | requestFailedCallbackDialog(errorResponse)                                   |
|                     | retrieveCaseFolders()                                                        |
|                     | retrieveCaseFoldersOnLoad()                                                  |
|                     | toggleAssigneeLabel(usersBucket)                                             |
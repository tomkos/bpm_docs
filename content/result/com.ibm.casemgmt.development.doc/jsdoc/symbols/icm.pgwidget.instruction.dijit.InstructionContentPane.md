...
# Class icm.pgwidget.instruction.dijit.InstructionContentPane

Class that represents Instruction widget
				
				
					
Defined in:  <icm\pgwidget\instruction\dijit\InstructionContentPane.js>.
...
|---------------------|--------------------------------------------|
|                     | constructor()                              |
|                     | showInstructionContent(workitem, solution) |
...
# Class icm.widget.properties.editors.model.RoleUserModel
...
Extends
       ...
       RoleUserModel class implements the Dojo dijit.tree.model class.
				
				
					
Defined in:  <icm\widget\properties\editors\model\RoleUserModel.js>.

...
# Class icm.dialog.openformdialog.OpenFormDialog
...
Extends
				...
				Represents the Add Task dialog. Case workers can add discretionary task.
				
				
					
Defined in:  <icm\dialog\openformdialog\OpenFormDialog.js>.

...
# Class icm.model.properties.controller.types.FloatPropertyController
...
Defined in:  <icm\model\properties\controller\types\FloatPropertyController.js>.

| Constructor Attributes   | Constructor Name and Description                                                                                         |
|--------------------------|--------------------------------------------------------------------------------------------------------------------------|
|                          | icm.model.properties.controller.types.FloatPropertyController() 							 Controller class for a property of type "float". |

A collection of property controllers is created and managed by a icm.model.properties.controller.PropertyCollectionController
...
icm.model.properties.controller.types.\_PropertyController.
 ...
 places - The number of decimal places allowed.

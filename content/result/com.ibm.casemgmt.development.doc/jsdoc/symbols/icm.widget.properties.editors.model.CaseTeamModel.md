...
# Class icm.widget.properties.editors.model.CaseTeamModel
...
Extends
				...
				Represents a model for the role tree that is used to display the hierarchy solution roles and its members. The
       CaseTeamModel class implements the Dojo dijit.tree.model class.
				
				
					
Defined in:  <icm\widget\properties\editors\model\CaseTeamModel.js>.
...
|---------------------|----------------------------------------------------------------------------------------------------------|
|                     | constructor(currCase)                                                                                    |
|                     | destroy()                                                                                                |
|                     | getChildren(parentItem, onComplete)                                                                      |
|                     | getIdentity(item) 								 Returns the identity for an item.                                             |
|                     | getLabel(item) 								 Returns a displayable name for an item.                                          |
|                     | getRoot(onItem)                                                                                          |
|                     | mayHaveChildren(item)                                                                                    |
|                     | onProcessingComplete(item) 								 This event is triggered when the model completes processing an item. |
|                     | onProcessingStarted(item) 								 This event is triggered when the model begins processing an item.     |
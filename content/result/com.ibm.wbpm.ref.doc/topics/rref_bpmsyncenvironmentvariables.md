...
The BPMSyncEnvironmentVariables command
...
and then copy environment variables from one snapshot to another.
...
wsadmin>AdminTask.BPMSyncEnvironmentVariables(’[-containerAcronym HSS -sourceContainerSnapshotAcronym "V1" -targetContainerSnapshotAcronym "V2"]’)
```
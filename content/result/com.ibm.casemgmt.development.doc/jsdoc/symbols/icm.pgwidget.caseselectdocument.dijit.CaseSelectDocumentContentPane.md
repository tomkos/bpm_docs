...
# Class icm.pgwidget.caseselectdocument.dijit.CaseSelectDocumentContentPane

Defined in:  <icm\pgwidget\caseselectdocument\dijit\CaseSelectDocumentContentPane.js>.
...
|--------------------|----------------------------------------------------------------------------------------------------------|
|                    | autoHeight  autoHeight flag for content list                                                             |
|                    | originalCaseDocsPane  The origianl case docs pane                                                        |
|                    | selectedDocsTree  selected docs tree dijit                                                               |
|                    | selectedDocsTreeItems  An array of ecm.model.ContentItem representing the items in the selected doc tree |
|                    | selectedDocsTreeModel  selected docs tree model                                                          |
|                    | selectedDocsTreeStore  selected docs tree store                                                          |
|                    | splitCaseEditable  An instance of icm.model.CaseEditable representing the case being splited             |

| Method Attributes   | Method Name and Description                                                                                                            |
|---------------------|----------------------------------------------------------------------------------------------------------------------------------------|
|                     | addDocumentItem(parent, item) 								 Add a document to the selected docs tree model, and return the added document item.             |
|                     | addFolderItem(parent, foldername, folderPath) 								 Add a folder to the selected docs tree model, and return the added folder item. |
|                     | clearContent() 								 Clear the content pane.                                                                                        |
|                     | clearOriginalCaseDocsPane() 								 Clear the list of original documents.                                                             |
|                     | clearSelectedDocsPane() 								 Clear the selected documents.                                                                         |
|                     | destroy()                                                                                                                              |
|                     | expandCurrentFolderItem() 								 Expand the current folder item in the selected docs tree model                                      |
|                     | expandFolder(folderItem) 								 Expand a folder in the selected docs tree model                                                      |
|                     | getFolderItem(parent, folderPath) 								 Get the folder item for a subfolder in the selected docs tree model                         |
|                     | getIconStyle(item) 								 Get the icon class for an item in the selected docs tree.                                                  |
|                     | hide() 								 Hide the content pane.                                                                                                 |
|                     | selectDocs() 								 Handler invoked when the list of selected documents changes.                                                     |
|                     | show() 								 Show the content pane.                                                                                                 |
|                     | showContentNode() 								 Show the widget.                                                                                            |
|                     | showSelectedDocsTree() 								 Show the selected documents tree                                                                       |
|                     | splitCase(caseEditable) 								 Split a case given a caseEditable model object.                                                       |
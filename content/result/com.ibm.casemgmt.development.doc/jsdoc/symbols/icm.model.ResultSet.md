...
Defined in:  <icm\model\ResultSet.js>.

| Constructor Attributes   | Constructor Name and Description                                 |
|--------------------------|------------------------------------------------------------------|
|                          | icm.model.ResultSet(properties) 							 Constructs a result set. |

| Field Attributes   | Field Name and Description                                                                 |
|--------------------|--------------------------------------------------------------------------------------------|
|                    | continuationData  Data that is provided to the server to request the next page of results. |
|                    | endWindow  The end time window.                                                            |
|                    | items  The current items in the result set.                                                |
|                    | setType  Indicates the type of items in this result set                                    |
|                    | startWindow  The start time window.                                                        |

| Method Attributes   | Method Name and Description                                                                                                                      |
|---------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | hasContinuation() 								 Returns the boolean value true if continuation data has been defined on this result set.                              |
|                     | retrieveNextPage(callback, errback, backgroundRequest) 								 Retrieves the next page of items using the continuation data for the result set. |
...
# Class icm.action.document.DocumentShare

Extends
					icm.action.NavigatorAction.

				
			
				Launches share dialog of the document. It "inherits" from SharePluginShareAction action in of ICM Share Plug-in. 

       Context required by this action: ['Document'] 

Defined in:  <icm\action\document\DocumentShare.js>.
...
|--------------------|-------------------------------------------------------------------------|
|                    | SHARE\_CONFIG\_VERSION  The supported share configuration version.        |
|                    | UNSUPPORTED\_MIME\_TYPES  These document MIME types should not be shared. |

| Method Attributes   | Method Name and Description                                                                                    |
|---------------------|----------------------------------------------------------------------------------------------------------------|
|                     | getExternalDirectory(repository) 								 Returns the external directory of the given repository.              |
|                     | isEnabled()                                                                                                    |
|                     | isEntryTemplate(item) 								 Returns true if the given item is an entry template.                            |
|                     | isItemSharable(item) 								 Returns true if the given item is sharable, i.e.                                 |
|                     | isRepositorySupported(repository) 								 Returns true if the given repository is supported.                  |
|                     | isShareConfigured(repository) 								 Returns true if the given repository is configured for share.           |
|                     | isShareEnabled(repository) 								 Returns true if the given repository is share-enabled.                     |
|                     | isVisible()                                                                                                    |
|                     | shareActionIsAllowedForItem(item) 								 Returns true if the share action is allowed for the given item.     |
|                     | shareActionIsEnabledForItem(item) 								 Returns true if the share action can be enabled for the given item. |
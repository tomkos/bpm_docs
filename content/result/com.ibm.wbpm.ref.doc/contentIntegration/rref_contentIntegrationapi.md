# ContentIntegration toolkit JavaScript API
...
The BPM File Dropzone view allows users to drag or select files from their computer file system to store in the BPM document store.
...
The BPM File Properties view displays and allows users to view, change and delete properties associated with an BPM file/document.

BPM File Revisions

The BPM File Revisions view displays (in tabular form) revisions of an BPM file/document given the id of that document. Events can be fired from user actions on the list, such as clicking on a file.
...
The ECM File Properties view displays and allows users to view, change and delete properties associated with an ECM file/document.

ECM File Revisions

The ECM File Revisions view displays (in tabular form) revisions of an ECM file/document given the id of that document. Events can be fired from user actions on the list, such as clicking on a file.
...
The ECM Folder List view displays (in tabular form) folders from the ECM content store. Events can be fired from user actions on the list, such as clicking on a folder. Folders can also be deleted from the list, if allowed through configuration.

File Viewer

The File Viewer view allows users to view files that have been uploaded using either the BPM File Dropzone or BPM File Uploader, it should be used in conjunction with the BPM File List.
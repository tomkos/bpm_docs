...
- java.lang.Object
    - com.ibm.bpe.api.BinaryCustomProperty
...
Describes a custom property that has a binary value.
 ...
 those provided and managed by the Business Flow Manager, for example, a JSP.
 
 The binary custom property may be searched for when an additional queryable string is provided.
 The data type should specify the type of the binary value. It is, however, not checked by the Business Flow Manager.
Since:
6.2

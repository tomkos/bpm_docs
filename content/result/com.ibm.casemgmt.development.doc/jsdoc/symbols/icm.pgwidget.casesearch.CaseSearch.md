...
# Class icm.pgwidget.casesearch.CaseSearch
...
Defined in:  <icm\pgwidget\casesearch\CaseSearch.js>.
...
|---------------------|---------------------------------------------------------------------------------|
|                     | fireEvent(search, bMyCasesSeach)                                                |
|                     | handleClearContent() 								 Handler for icm.ClearContent event.               |
|                     | handleICM\_SearchMyCasesEvent() 								 Handler for the icm.SearchMyCases event |
|                     | initialize()                                                                    |
|                     | postCreate()                                                                    |
|                     | retrieveBOCEQuery(payload)                                                      |
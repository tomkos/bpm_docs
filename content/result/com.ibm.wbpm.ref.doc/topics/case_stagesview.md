...
When Case Stages view is used in the context of the process user task page, the view configures
...
| Orientation                 | To configure how the case stages display are aligned (vertically or horizontally) in the view. By default these appear horizontally. | Boolean     |

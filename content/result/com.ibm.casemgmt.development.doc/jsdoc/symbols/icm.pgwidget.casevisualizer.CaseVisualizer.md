...
|---------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | handleICM\_ClearContentEvent() 								 Handler for the ClearContent event.                                                                                                 |
...
|                     | handleICM\_SendWorkItemEvent(payload) 								 Handler for the icm.SendWorkItem event.The Timeline Visualizer for the case in the payload  will be displayed in the widget. |
...
- workItemEditable: An icm.model.WorkItemEditable object that represents the workitem for which the case to be displayed.
 coordination: An icm.util.Coordination object that is used internally by the widgets in the same page.
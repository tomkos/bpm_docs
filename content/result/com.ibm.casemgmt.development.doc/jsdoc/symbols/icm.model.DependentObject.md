...
# Class icm.model.DependentObject
...
Extends
				...
				Represents a DependentObject that is in the value of an application-defined dependent object property.  These objects exist solely within a parent object, such as a Case.
				
				
					
Defined in:  <icm\model\DependentObject.js>.

| Constructor Attributes   | Constructor Name and Description                                                   |
|--------------------------|------------------------------------------------------------------------------------|
|                          | icm.model.DependentObject(properties) 							 Constructs a DependentObject object. |

| Field Attributes   | Field Name and Description                                                                                                     |
|--------------------|--------------------------------------------------------------------------------------------------------------------------------|
|                    | attributes  The attributes object contains the values for the user and system attributes that are associated with this object. |
|                    | attributeTypes  An object containing the types for the user and system attributes that are associated with this object.        |
|                    | contentClass  The ecm.model.ContentClass object describing the class of this dependent object.                                 |

| Method Attributes   | Method Name and Description                                                             |
|---------------------|-----------------------------------------------------------------------------------------|
|                     | copy() 								 Returns another DependentObject instance that is a copy of this object. |
|                     | equals(other) 								 Compares this object to another DependentObject instance.        |
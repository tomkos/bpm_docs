...
# Class icm.util.WorkItemHandler
...
Extends
				...
				Provides a utility class for handling work items. This class examines the locked state of a work item and notifies
...
Defined in:  <icm\util\WorkItemHandler.js>.

| Constructor Attributes   | Constructor Name and Description                                                                      |
|--------------------------|-------------------------------------------------------------------------------------------------------|
|                          | icm.util.WorkItemHandler(broadcastInvoker, inactivePage) 							 Constructs a WorkItemHandler object. |

| Method Attributes   | Method Name and Description                                                                                                                                                                  |
|---------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | constructor(broadcastInvoker, inactivePage)                                                                                                                                                  |
|                     | handleCurrentPageWorkItem(icmWorkItem) 								 Examines the state of the work item and broadcasts the icm.OpenWorkItem event if the work item can  be opened.                               |
|                     | handleNextWorkItem(icmWorkItem, prevPage)                                                                                                                                                    |
|                     | handleNextWorkItemBySequence(icmWorkItem)                                                                                                                                                    |
|                     | handleSimultaneousAccess(icmWorkItem)                                                                                                                                                        |
|                     | handleURLBpmWorkItem(workItem)                                                                                                                                                               |
|                     | handleWorkItem(icmWorkItem) 								 Examines the state of the work item and broadcasts the icm.OpenWorkItem event if the work item can be opened.                                           |
|                     | isInbasketEmpty(icmWorkItem, originalInbasket, self, processedItem) 								 Retrieves the next work item in the in-basket and passes it to the handleWorkItem(icmWorkItem)  for processing. |
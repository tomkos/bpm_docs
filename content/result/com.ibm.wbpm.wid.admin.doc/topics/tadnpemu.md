...
page of the integration test client and that Programmatic
emulation is still selected, then click New.
(Information about defining an emulator as programmatic is found in
the topic "Redefining emulators as programmatic.")
...
you want to emulate in the Select an interface to emulate list.

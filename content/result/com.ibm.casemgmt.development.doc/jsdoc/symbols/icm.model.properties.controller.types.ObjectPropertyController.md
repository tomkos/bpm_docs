...
# Class icm.model.properties.controller.types.ObjectPropertyController
...
Defined in:  <icm\model\properties\controller\types\ObjectPropertyController.js>.

| Constructor Attributes   | Constructor Name and Description                                                                                         |
|--------------------------|--------------------------------------------------------------------------------------------------------------------------|
|                          | icm.model.properties.controller.types.ObjectPropertyController() 							 Controller class for property of type "object". |
...
icm.model.properties.controller.types.\_PropertyController.
 ...
 hasDependentProperties - The boolean value indicating dependent properties of the object.
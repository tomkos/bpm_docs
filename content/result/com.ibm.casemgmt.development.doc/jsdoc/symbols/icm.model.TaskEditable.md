...
|--------------------------|------------------------------------------------------------------------------|
|                          | icm.model.TaskEditable(properties) 							 Constructs a TaskEditable object. |

| Field Attributes   | Field Name and Description                                                                                                             |
|--------------------|----------------------------------------------------------------------------------------------------------------------------------------|
|                    | icmTask  The Task object corresponding to this Editable object.                                                                        |
|                    | launchStep  The LaunchStep object that allows launch step parameters to be filled in if this Editable object represents a new task.    |
|                    | pendingAction  Indicates a pending action is associated with this TaskEditable.                                                        |
|                    | pendingCreate  Indicates that this Editable object represents a new task that has not yet been saved.                                  |
|                    | propertiesCollection  A collection of icm.model.PropertyEditable objects that represent the properties that are defined for this task. |
|                    | taskType  The TaskType object for this TaskEditable.                                                                                   |

| Method Attributes   | Method Name and Description                                                                                                                                                       |
|---------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <static>            | icm.model.TaskEditable.createNew(caseInst, taskType, callback, errCallback, backgroundRequest) 								 A factory method to get a TaskEditable object that represents a new Task. |
| <static>            | icm.model.TaskEditable.fromTask(task) 								 A factory method that gets a TaskEditable object from a Task object.                                                               |
|                     | getAddTaskPage() 								 Gets the page to add this new task.                                                                                                                     |
|                     | getCase() 								 Returns the Case object associated with this TaskEditable.                                                                                                     |
|                     | getCaseType() 								 Returns the CaseType associated with this TaskEditable.                                                                                                    |
|                     | getDefaultViewDefinition() 								 The default view reference name for this task.                                                                                                |
|                     | getIsToDo() 								 Convenience method to return an indicator of whether this task is a Todo.                                                                                    |
...
|                     | getTaskTypeName() 								 Convenience method to return the task type name.                                                                                                       |
|                     | getViewDefinitionUri(viewDefinitionId) 								 Returns the URI for the specified view definition.                                                                                |
|                     | isDependentPropertiesRetrievalPending() 								 Indicates if retrieveDependentProperties() should be called to resolve dependent properties on the server.                       |
...
|                     | save(callback, errCallback, backgroundRequest) 								 Saves the task changes.                                                                                                   |
|                     | setCompleted() 								 Establishes the intent to complete the task.                                                                                                              |
|                     | setDisabled() 								 Establishes the intent to disable the task.                                                                                                                |
|                     | setEnabled() 								 Establishes the intent to enable the task.                                                                                                                  |
|                     | setRestarted() 								 Establishes the intent to restart the task.                                                                                                               |
|                     | setStarted() 								 Establishes the intent to start the task.                                                                                                                   |
|                     | setStopped() 								 Establishes the intent to stop the task.                                                                                                                    |
|                     | setTaskName(taskName) 								 Sets the task name of the task                                                                                                                     |
|                     | toJSON()                                                                                                                                                                          |
...
- "pageClass" = a path used to access the resource for this page.  For example: 
     "<TOS>/<prefix>/CmAcmSTEP\_LAUNCH\_DEFAULT\_PAGE"
- "pageName" = the name of the page, for example "CmAcmSTEP\_LAUNCH\_DEFAULT\_PAGE"
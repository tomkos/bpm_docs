...
# Class icm.pgwidget.inbasket.dijit.InbasketContentPane

Defined in:  <icm\pgwidget\inbasket\dijit\InbasketContentPane.js>.
...
|---------------------|--------------------------------------------------------------------------------------------|
|                     | cleanEventFilter(inbasket)                                                                 |
|                     | cleanUIFilter(inbasket)                                                                    |
|                     | clearFilterByReset()                                                                       |
|                     | clearQueryMap()                                                                            |
|                     | configureFilterArea(index)                                                                 |
|                     | constructor()                                                                              |
|                     | createContentList(index)                                                                   |
|                     | createPushInstruction(index)                                                               |
|                     | destroy()                                                                                  |
|                     | executeFilter()                                                                            |
|                     | getColumnDecorator() 								 Method to provide column decorators for columns in Inbasket. |
|                     | getLockedByMyselfQueryFilter(inbasket)                                                     |
|                     | getLockedByMyselfSubstitutionVars(inbasket)                                                |
|                     | getUIFilterQuery(inbasket)                                                                 |
|                     | getUIFilterQuerySubstitutionVars(inbasket)                                                 |
|                     | getUnLockQueryFilter(inbasket)                                                             |
|                     | getUnLockSubstitutionVars(inbasket)                                                        |
|                     | handleOverflowAndTooltipTabName(index)                                                     |
|                     | hideFilterArea(index)                                                                      |
|                     | hideTab()                                                                                  |
|                     | init(inbaskets)                                                                            |
|                     | initContentPane()                                                                          |
|                     | initQueryMap()                                                                             |
...
|                     | openItemByLink()                                                                           |
|                     | openPullInbasket(index)                                                                    |
|                     | openPushInbasket(index)                                                                    |
|                     | postCreate()                                                                               |
|                     | resetFilters()                                                                             |
|                     | selectInbasket()                                                                           |
|                     | selectWorkItem()                                                                           |
|                     | setFilterPayload(payload)                                                                  |
|                     | setGridDecorator(resultSet)                                                                |
|                     | setGridStructure(resultSet)                                                                |
|                     | setModel(model)                                                                            |
|                     | setPushInbasketActionContext()                                                             |
|                     | setTabDisplayName(name, count, index)                                                      |
|                     | stopEvent(event)                                                                           |
|                     | workAssignRefresh()                                                                        |
...
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------|-----------|
| Value when selected: | The value that the binding is set to when this radio button is selected.                                                                   | String    |
| Group name:          | The group that this radio button belongs to. When this radio button is selected, all other radio buttons in the same group are deselected. | String    |

...
activities in the selected BPD that use the same tag groups display
...
- Visualize BPD data variables (deprecated)

 Traditional: 
Select and visualize the local input, output, or private variables used in a BPD.
- Visualize BPD tag groups (deprecated)

 Traditional: 
Select and visualize the tag groups defined for a BPD.
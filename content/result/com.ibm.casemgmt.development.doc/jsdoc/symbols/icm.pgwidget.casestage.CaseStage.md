...
# Class icm.pgwidget.casestage.CaseStage

Extends
					icm.pgwidget.casestage.dijit.CaseStageContentPane, icm.base.BasePageWidget.
...
Defined in:  <icm\pgwidget\casestage\CaseStage.js>.

| Constructor Attributes   | Constructor Name and Description                             |
|--------------------------|--------------------------------------------------------------|
|                          | icm.pgwidget.casestage.CaseStage() 							 Case Stage Widget |

| Method Attributes   | Method Name and Description                                                                                          |
|---------------------|----------------------------------------------------------------------------------------------------------------------|
|                     | handleICM\_completeStageEvent(payload)                                                                                |
|                     | handleICM\_RefreshStageEvent(payload) 								 Refreshes the case stages in the widget                                |
|                     | handleICM\_restartStageEvent(payload)                                                                                 |
...
|                     | handleICM\_StageChangedEvent(payload) 								 Handler for stage changed event.                                       |
|                     | handleICM\_ToggleOnHoldStageEvent(payload)                                                                            |

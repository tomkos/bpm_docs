...
# Class icm.pgwidget.processhistory.dijit.ProcessHistoryContentPane

Defined in:  <icm\pgwidget\processhistory\dijit\ProcessHistoryContentPane.js>.
...
|                     | render(model)                                                  |
|                     | reset(context)                                                 |
|                     | setModel(model) 								 Sets the model on the Process History |
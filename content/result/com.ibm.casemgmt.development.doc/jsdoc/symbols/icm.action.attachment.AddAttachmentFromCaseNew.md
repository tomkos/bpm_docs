...
# Class icm.action.attachment.AddAttachmentFromCaseNew
...
Extends
       ...
       Context required by this action: ['Attachment'] 

Defined in:  <icm\action\attachment\AddAttachmentFromCaseNew.js>.

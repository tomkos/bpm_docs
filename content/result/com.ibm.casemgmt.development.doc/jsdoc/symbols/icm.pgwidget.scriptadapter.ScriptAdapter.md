...
# Class icm.pgwidget.scriptadapter.ScriptAdapter
...
Defined in:  <icm\pgwidget\scriptadapter\ScriptAdapter.js>.
...
|---------------------|--------------------------------------------------------------------------------------------|
|                     | handleICM\_ReceiveEvent(payload) 								 Handler for receiving the event icm.ReceiveEvent. |
|                     | postCreate()                                                                               |
|                     | resize()                                                                                   |
|                     | theRunner(payload)                                                                         |
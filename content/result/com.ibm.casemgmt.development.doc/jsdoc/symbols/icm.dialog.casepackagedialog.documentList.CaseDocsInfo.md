...
# Class icm.dialog.casepackagedialog.documentList.CaseDocsInfo

Class that represent the Case documents section for the case package dialog
				
				
					
Defined in:  <icm\dialog\casepackagedialog\documentList\CaseDocsInfo.js>.
...
|                     | constructor()                                                                                                                     |
|                     | customResize()                                                                                                                    |
|                     | handleICM\_SelectCaseEvent(payload, self\_parent) 								 Handler for the icm.SelectCase event when selecting a case on case page. |
|                     | postCreate()                                                                                                                      |

...
# Class icm.dialog.managerolesdialog.ManageRolesDialog
...
Extends
				...
				Represents the Manage Roles dialog box in which members can be added to roles.
				
				
					
Defined in:  <icm\dialog\managerolesdialog\ManageRolesDialog.js>.

...
Extends
					icm.pgwidget.attachment.dijit.AttachmentContentPane, icm.pgwidget.attachment.\_AttachmentCoordinationMixin,
			 icm.base.BasePageWidget.
...
|---------------------|---------------------------------------------------------------------------------------------|
|                     | handleICM\_AddAttachmentEvent(payload) 								 Handler for icm.AddAttachment event.         |

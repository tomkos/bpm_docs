...
# Class icm.dialog.addtaskdialog.AddTaskDialog
...
Defined in:  <icm\dialog\addtaskdialog\AddTaskDialog.js>.
...
|                     | isMaxim()                                                                |
|                     | resize()                                                                 |
|                     | taskInputModified() 								 Disable ok button when name field is: 			1. |
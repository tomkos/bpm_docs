...
# Class icm.widget.dynamictaskeditor.flowsCommon.model.BaseFlowModel

Defined in:  <icm\widget\dynamictaskeditor\flowsCommon\model\BaseFlowModel.js>.
...
|                     | clone()                                                                                               |
|                     | constructor()                                                                                         |
|                     | escapeHTML(pString) 								 Escapes the HTML characters in string with corresponding escape sequence |
|                     | getDescription()                                                                                      |
|                     | getId()                                                                                               |
|                     | getProperties()                                                                                       |
|                     | getProperty(pPropName, pPropClass)                                                                    |
|                     | getType()                                                                                             |
|                     | propertiesToJson(pPadding)                                                                            |
|                     | setData(pData)                                                                                        |
|                     | setDescription(pDescription)                                                                          |
|                     | setId(pId)                                                                                            |
|                     | setProperties(pProperties)                                                                            |
|                     | setProperty(pPropName, pProperty)                                                                     |
|                     | toJson(pPadding)                                                                                      |
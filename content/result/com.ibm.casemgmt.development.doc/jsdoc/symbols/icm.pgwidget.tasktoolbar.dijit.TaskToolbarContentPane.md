...
# Class icm.pgwidget.tasktoolbar.dijit.TaskToolbarContentPane

Defined in:  <icm\pgwidget\tasktoolbar\dijit\TaskToolbarContentPane.js>.
...
|---------------------|---------------------------------------------------------|
|                     | buildToolbar(toolbarAttachPoint, disableGetNext)        |
|                     | constructor()                                           |
|                     | destroyRecursive() 								 destroy in case memory leak |
|                     | onCaseIdButtonClick()                                   |
|                     | onProcessLinkClick()                                    |
|                     | openBpmWorkItem(payload)                                |
|                     | postCreate()                                            |
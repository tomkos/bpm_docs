...
The setBPMEndpoint command is run using
...
The setBPMEndpoint command does not write to a
...
[-strategies strategy\_1,strategy\_2]
[-virtualHost virtual\_host\_hostname]
[-url url]
```
...
```
AdminTask.setBPMEndpoint( [ '-name', 'EXTERNAL\_CLIENT', '-url' ] )
```

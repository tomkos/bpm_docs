...
Defined in:  <icm\model\CaseComment.js>.

| Constructor Attributes   | Constructor Name and Description                                           |
|--------------------------|----------------------------------------------------------------------------|
|                          | icm.model.CaseComment(properties) 							 Constructs a CaseComment object. |

| Field Attributes   | Field Name and Description                               |
|--------------------|----------------------------------------------------------|
|                    | context  The context of this comment.                    |
|                    | creator  The user that created this comment.             |
|                    | dateCreated  The date and time this comment was created. |

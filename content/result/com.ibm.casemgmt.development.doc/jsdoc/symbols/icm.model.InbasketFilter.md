...
|--------------------------|------------------------------------------------------------------------|
|                          | icm.model.InbasketFilter() 							 Constructs a InbasketFilter object. |

| Field Attributes   | Field Name and Description                                  |
|--------------------|-------------------------------------------------------------|
|                    | filterFields  filter fields in dynamic filter.              |
...
|---------------------|---------------------------------------------------------------------------------------------------------------------|
| <static>            | icm.model.InbasketFilter.fromJSON(json) 								 A factory method to get a inbasket filter object from JSON object. |

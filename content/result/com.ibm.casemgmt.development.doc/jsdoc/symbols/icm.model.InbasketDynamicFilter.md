...
# Class icm.model.InbasketDynamicFilter
...
Defined in:  <icm\model\InbasketDynamicFilter.js>.

| Constructor Attributes   | Constructor Name and Description                                                     |
|--------------------------|--------------------------------------------------------------------------------------|
|                          | icm.model.InbasketDynamicFilter() 							 Constructs a InbasketDynamicFilter object. |

| Field Attributes   | Field Name and Description                                  |
|--------------------|-------------------------------------------------------------|
|                    | hideFilterUI  true is hide Inbasket widget filter           |
|                    | hideLockedByOther  true is hide work items locked by other. |
|                    | inbasketName  inbasket name in dynamic filter.              |
|                    | query\_bpmVars  for filtering process work items             |
|                    | queryFields  query fields in dynamic filter.                |
|                    | queryFilter  query filter in dynamic filter.                |
|                    | queueName  Queue name in dynamic filter.                    |

| Method Attributes   | Method Name and Description                                                                                               |
|---------------------|---------------------------------------------------------------------------------------------------------------------------|
| <static>            | icm.model.InbasketDynamicFilter.fromJSON(json) 								 A factory method to get a dynamic filter object from JSON object. |
...
var json = {
		...
		"queryFilter":"(DY\_Company = :A) OR (DY\_Company = :A AND DY\_LOC = :A) AND (DY\_Int > :A)"

...
# Class icm.pgwidget.casevisualizer.dijit.TimelineRuleSlider

Defined in:  <icm\pgwidget\casevisualizer\dijit\TimelineRuleSlider.js>.
...
|                     | postCreate()                                                    |
|                     | refresh()                                                       |
|                     | renderRule(width, height, shortFormat) 								 Render the rule |
|                     | resize(width, height)                                           |
|                     | setRange(data)                                                  |
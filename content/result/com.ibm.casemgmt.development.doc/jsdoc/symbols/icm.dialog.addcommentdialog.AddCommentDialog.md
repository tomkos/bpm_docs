...
Extends
       ...
       work item. Case workers use this dialog box to review the comments and add new comments.
...
|---------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | constructor(artifactType, artifactLabel, commentContext, caseModel, documentTitle, docId, workItem) 								 Constructs an Add Comment dialog box. |
|                     | shouldConfirmCancel() 								 Determines whether the dialog box can be closed.                                                                    |
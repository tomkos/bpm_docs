...
# Class icm.pgwidget.markup.Markup

Extends
					icm.pgwidget.markup.dijit.MarkupContentPane, icm.base.BasePageWidget.

Defined in:  <icm\pgwidget\markup\Markup.js>.

| Constructor Attributes   | Constructor Name and Description                   |
|--------------------------|----------------------------------------------------|
|                          | icm.pgwidget.markup.Markup() 							 Markup Widget |

| Method Attributes   | Method Name and Description                                                       |
|---------------------|-----------------------------------------------------------------------------------|
|                     | handleICM\_ClearContentEvent(payload) 								 Clears the contents of the widget   |
|                     | handleICM\_ReceiveMarkupEvent(payload) 								 Updates the contents of the widget |
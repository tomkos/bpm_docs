...
|---------------------|------------------------------------------------------------------------------------|
|                     | onBroadcastEvent(eventName, payload) 								 Sends the specified broadcast event. |
|                     | onPublishEvent(eventName, payload) 								 Sends the specified published event.   |
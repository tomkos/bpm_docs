...
# Class icm.pgwidget.tasktoolbar.TaskToolbar

Extends
					icm.base.BasePageWidget, icm.pgwidget.tasktoolbar.TaskToolbarContentPane.

				
			
				Class that represents Task Toolbar widget to display header information for a process instance or task.
				
				
					
Defined in:  <icm\pgwidget\tasktoolbar\TaskToolbar.js>.
...
|                     | handleReceiveWorkItemId()                                                             |
|                     | postCreate()                                                                          |
|                     | startup()                                                                             |

- workItemEditable: An icm.model.WorkItemEditable object that represents the work item whose content is to be displayed.
 Action: A view-type attribute that is used internally by the widget to show a specific view of the process task. 
 Possible values include: "viewInstance", "viewDiagram" or "viewAudit".
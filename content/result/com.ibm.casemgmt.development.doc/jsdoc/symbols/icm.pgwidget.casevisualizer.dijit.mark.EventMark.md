...
# Class icm.pgwidget.casevisualizer.dijit.mark.EventMark

Defined in:  <icm\pgwidget\casevisualizer\dijit\mark\EventMark.js>.
...
|                     | getType()                                                                                                      |
|                     | highlight()                                                                                                    |
|                     | layout() 								 Does the layout for this event, sets the position that this EventMark should be rendered at. |
|                     | onClick(event)                                                                                                 |
|                     | onMouseOut(event)                                                                                              |
|                     | onMouseOver(event)                                                                                             |
|                     | render()                                                                                                       |

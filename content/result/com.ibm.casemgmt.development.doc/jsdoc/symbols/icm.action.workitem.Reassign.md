...
Extends
				...
				Reassigns the selected work item to another user. If the work item is open, this action first closes the work item. 

       Context required by this action: [['WorkItem', 'Solution', 'Role']]

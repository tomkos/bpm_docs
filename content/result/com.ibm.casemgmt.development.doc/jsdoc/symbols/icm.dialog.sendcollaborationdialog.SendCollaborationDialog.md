...
# Class icm.dialog.sendcollaborationdialog.SendCollaborationDialog
...
Defined in:  <icm\dialog\sendcollaborationdialog\SendCollaborationDialog.js>.
...
|                     | constructor()                                                                                 |
|                     | postCreate()                                                                                  |
|                     | resize() 								 Resizes the dialog box, padding the ecm.widget.MultiValueChoicePane widget. |
|                     | show() 								 Makes the dialog box visible and sets up the onChanged behavior.              |
...
Defined in:  <icm\model\TimelineEvent.js>.

| Constructor Attributes   | Constructor Name and Description                                     |
|--------------------------|----------------------------------------------------------------------|
|                          | icm.model.TimelineEvent() 							 Constructs a TimelineEvent object. |

| Field Attributes   | Field Name and Description                                   |
|--------------------|--------------------------------------------------------------|
|                    | action  Action of the event took.                            |
|                    | entityId  GUID of the target case object                     |
|                    | entityName  Name of the case object on which event occurred. |
|                    | eventId  GUID of event.                                      |
|                    | eventProperties  Array of properties.                        |
|                    | eventTime  Event occurred time.                              |
|                    | eventType  The type of the event.                            |
|                    | parentId  GUID of parent.                                    |
|                    | userName  Name of the case worker that caused the event.     |
...
| Background color style:         | The color style of the chart background. {Transparent | Primary | Info | Success | Warning | Danger}     | ChartBackgroundColorStyle   |
|---------------------------------|----------------------------------------------------------------------------------------------------------|-----------------------------|
| Data series color style:        | The palette used for chart data. {Default | Primary | Info | Success | Warning | Danger}                 | ChartDataSeriesColorStyle   |
...
| Legend placement:               | Set legend placement for the chart {None | Bottom-Center | Middle-Right}                                 | ChartLegendPlacement        |
...
| Chart data mode:   | The method used to populate chart data, from a service or from the config option. To populate drill down trees, you must use a service. {From Service | From Config Option}   | ChartDataMode   |
|--------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|
| Data service:      | Data service to use for populating chart when in data service mode.                                                                                                           |                 |
...
| Show tooltip:      | When enabled, tooltip which shows data point label and value will apear when hovering over data in chart                                                                      | Boolean         |

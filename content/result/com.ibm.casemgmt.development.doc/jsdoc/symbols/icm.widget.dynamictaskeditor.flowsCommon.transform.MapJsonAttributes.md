...
# Class icm.widget.dynamictaskeditor.flowsCommon.transform.MapJsonAttributes

Defined in:  <icm\widget\dynamictaskeditor\flowsCommon\transform\MapJsonAttributes.js>.
...
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | buildMapJsonAttachments(atts)                                                                                                                                                                   |
|                     | buildMapJsonDataFields(dfs)                                                                                                                                                                     |
|                     | buildMapJsonWorkgroups(wgs) 								 transformMapJsonToWorkgroups: function() 	{ 		var workgroups = this.getMapWorkgroups(this.mapJson); 		var wgModels = []; 		for(i=0, l=workgroups.length; i |
|                     | constructor(args)                                                                                                                                                                               |
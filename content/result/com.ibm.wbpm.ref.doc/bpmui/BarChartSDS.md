...
| Show value labels:              | Shows the data point values above each point.                                                            | Boolean                     |
...
| Gridlines style:                | The style of the horizontal line. {None | Light | Dark}                                                  | ChartGridLinesStyle         |
...
|-------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|
| Data service:           | Data service that populates the DataSeries.                                                                                                                              |                 |
...
| Y axis tick precision:  | The number of decimal places displayed in Y axis tick labels. The default is 0                                                                                           | Integer         |

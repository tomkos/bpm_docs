...
public interface PIID
extends OID
Interface for a process instance object identifier.
 
 A process instance object identifier uniquely identifies a process instance.
 It is created when the process instance is created and stays with the process instance
 during its lifetime.
 
 The object identifier can be retrieved using the
 getID() method of the process instance.
Since:
5.0

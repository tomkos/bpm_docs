...
# Class icm.pgwidget.casetoolbar.dijit.CaseToolbarContentPane

Defined in:  <icm\pgwidget\casetoolbar\dijit\CaseToolbarContentPane.js>.
...
|                     | hideHeaderInfo()                                                                                                       |
|                     | postCreate()                                                                                                           |
|                     | renderUI(caseItem) 								 Render UI according to Case Item                                                           |
|                     | updateCaseInfo(caseItem)                                                                                               |
|                     | updateCaseTitle(showingCase)                                                                                           |

- toolbarAttachPoint: indicate which toolbar attachpoint of editing a case, adding a case and splitting a case should be used for getting the settings of actions;

- caseItem: caseEditable object handled for being shown
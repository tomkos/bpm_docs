...
a widget and actions. Widgets that leverage the IBM Case Manager action framework to provide 
toolbars or menus should implement this interface.
...
|--------------------------|-------------------------------------------------------------------------------------------------------------------------------|
|                          | icm.base.BaseActionContext() 							 Constructs an interface for exchanging context information between a widget and actions. |

| Method Attributes   | Method Name and Description                                             |
|---------------------|-------------------------------------------------------------------------|
|                     | cleanActionContext(ctx) 								 Removes the specified action context.  |
|                     | constructor()                                                           |
|                     | getActionContext(ctx) 								 Gets the specified context object.       |
|                     | setActionContext(ctx, ctxObj, append) 								 Sets the context object. |
...
# Class icm.model.TimelineOverview
...
Defined in:  <icm\model\TimelineOverview.js>.

| Constructor Attributes   | Constructor Name and Description                                           |
|--------------------------|----------------------------------------------------------------------------|
|                          | icm.model.TimelineOverview() 							 Constructs a TimelineOverview object. |

| Field Attributes   | Field Name and Description                            |
|--------------------|-------------------------------------------------------|
|                    | bins  Bins contain event counts.                      |
|                    | caseId  The identifier of the case.                   |
|                    | caseName  The name of the case.                       |
|                    | caseStatus  The status of the case.                   |
|                    | firstEventTime  The time of the first event occurred. |
|                    | lastEventTime  The time of the last event occurred.   |
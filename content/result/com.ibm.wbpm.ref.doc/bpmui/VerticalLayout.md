...
| Layout flow:          | Layout of the child views. Note\: Do not use Justified when the layout is Inline Scroll or Auto-Wrap. Combining these options may result in unexpected layout behavior. {Vertical | Vertical Tight | Horizontal | Horizontal Inline Scroll | Horizontal Tight | Horizontal Auto-wrap}   | LayoutFlow          |
|-----------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------|
| Horizontal alignment: | Horizontal alignment of child views. Note\: Do not use Justified when the layout is Inline Scroll or Auto-Wrap. Combining these options may result in unexpected layout behavior. {Justified | Left | Center | Right}                                                                   | HorizontalAlignment |

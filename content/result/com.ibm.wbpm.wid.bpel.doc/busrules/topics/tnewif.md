...
1. In the rule set editor, click the Add If-then
rule icon (). A new rule
appears.
...
you for a value, or you can compose it yourself by clicking the appropriate
operators and values in sequence.
4 Set the action as follows:

1. In the Then row, click Action.
A pop-up window appears.
2. As earlier, use the choices in the window to set the
action. You can either choose an existing template which
will then prompt you for a value, or you can set it yourself by choosing
from one of the other options.

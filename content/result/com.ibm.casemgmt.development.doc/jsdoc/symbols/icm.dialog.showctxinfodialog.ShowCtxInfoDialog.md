...
# Class icm.dialog.showctxinfodialog.ShowCtxInfoDialog
...
Extends
				...
				Represents the ICM Context Information dialog box. A user can use this dialog box to view basic context information such as
solution name and role name.
				
				
					
Defined in:  <icm\dialog\showctxinfodialog\ShowCtxInfoDialog.js>.
...
|---------------------|--------------------------------------------------------------------------------------------------|
|                     | constructor(solution, role) 								 Constructs an instance of the Show Context Info dialog box. |
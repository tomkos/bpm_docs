...
# Class icm.container.ICMContentPane

Defined in:  <icm\container\ICMContentPane.js>.
...
|---------------------|----------------------------------------------------------------------------------------------------|
|                     | addFeatureContextSelector(domNode)                                                                 |
|                     | constructor()                                                                                      |
|                     | destroy()                                                                                          |
|                     | focus()                                                                                            |
|                     | getEditableUserPreferences(solution, userShortName, callback, errCallback, backgroundRequest)      |
|                     | getPagesCollection(index)                                                                          |
|                     | loadContent()                                                                                      |
|                     | onCreatePagesCollection(pagesCollection)                                                           |
|                     | postCreate()                                                                                       |
|                     | renderSolutionSelector(solutions, solution, role)                                                  |
|                     | retrievePagesCollection(solution, role, callback)                                                  |
|                     | setAddressRendererCallback(callback)                                                               |
|                     | setUserBPMLocale(solution, userShortName, currentLocale, callback, errCallback, backgroundRequest) |
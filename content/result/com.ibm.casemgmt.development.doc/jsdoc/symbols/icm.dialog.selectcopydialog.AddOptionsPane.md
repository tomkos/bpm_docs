...
# Class icm.dialog.selectcopydialog.AddOptionsPane
...
Extends
				...
				Displays options to add a Box document as a reference or as a copy. (Box Copy)
				
				
					
Defined in:  <icm\dialog\selectcopydialog\AddOptionsPane.js>.

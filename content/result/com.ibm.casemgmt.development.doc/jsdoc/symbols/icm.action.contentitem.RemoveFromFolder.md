...
# Class icm.action.contentitem.RemoveFromFolder
...
Extends
       ...
       Context required by this action: [['Document', 'CurrentFolder'], ['ProxyDocument','CurrentFolder']]

Defined in:  <icm\action\contentitem\RemoveFromFolder.js>.

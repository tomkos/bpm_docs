...
# Class icm.pgwidget.casevisualizer.dijit.mark.SeriesMark

Visual representation for a series in ICM
				
				
					
Defined in:  <icm\pgwidget\casevisualizer\dijit\mark\SeriesMark.js>.

| Constructor Attributes   | Constructor Name and Description                                   |
|--------------------------|--------------------------------------------------------------------|
|                          | icm.pgwidget.casevisualizer.dijit.mark.SeriesMark(event, timeline) |

| Method Attributes   | Method Name and Description                                                                                                                                                                                                                                            |
|---------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | addEllipsis()                                                                                                                                                                                                                                                          |
|                     | calculateInViewport()                                                                                                                                                                                                                                                  |
|                     | clear() 								 Clears this mark from the DOM                                                                                                                                                                                                                         |
|                     | constructor(params)                                                                                                                                                                                                                                                    |
|                     | destroy()                                                                                                                                                                                                                                                              |
|                     | getChildren() 								 Gets the ids for the children of this series                                                                                                                                                                                                    |
|                     | getFirstColumnWidth()                                                                                                                                                                                                                                                  |
|                     | getModel()                                                                                                                                                                                                                                                             |
|                     | groupEvents(events)                                                                                                                                                                                                                                                    |
|                     | hasDomElement()                                                                                                                                                                                                                                                        |
|                     | hide() 								 Sets the [visible] flag to false and removes this mark from the dom                                                                                                                                                                                    |
|                     | isVisible()                                                                                                                                                                                                                                                            |
|                     | layout() 								 Does the layout for the SeriesMark on the timeline.                                                                                                                                                                                                  |
|                     | onClick(event)                                                                                                                                                                                                                                                         |
|                     | onMouseOut(event)                                                                                                                                                                                                                                                      |
|                     | onMouseOver(event)                                                                                                                                                                                                                                                     |
|                     | removeTwistie()                                                                                                                                                                                                                                                        |
|                     | render() 								 Renders the SeriesMark on the timeline.                                                                                                                                                                                                              |
|                     | renderEvents() 								 Renders the events that are part of this series.                                                                                                                                                                                               |
|                     | setY(yCoord) 								 Sets the Y position of this series mark (and all its events)                                                                                                                                                                                     |
|                     | show() 								 Sets the [visible] flag to true.                                                                                                                                                                                                                       |
|                     | toggleChildren(showChildren, openedIds) 								 Toggles the display of this series children.                                                                                                                                                                          |
|                     | updateEvents(events, noRender) 								 Callback that is called when new events are added to the series                                                                                                                                                                |
|                     | updateMark() 								 Update mark updates the properties of the various graphical objects that make up the series mark these objects are created during the call to render, subsequent calls to render will generally delegate to this method to update positions etx. |
|                     | updateTwistie() 								 Updates the state of the twistie.                                                                                                                                                                                                             |
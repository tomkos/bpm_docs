...
# Class icm.pgwidget.todolist.dijit.quicktask.FilteringSelect
...
Extends
				...
				Provides a combination box that consists of a drop-down list and a field. The user can select a value from
...
Defined in:  <icm\pgwidget\todolist\dijit\quicktask\FilteringSelect.js>.
...
|---------------------|---------------------------------------------------------|
|                     | isValid() 								 Returns boolean indicating if valid. |
|                     | postCreate()                                            |
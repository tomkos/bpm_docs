...
# Class icm.dialog.addcommentdialog.dijit.CommentContentPane
...
Defined in:  <icm\dialog\addcommentdialog\dijit\CommentContentPane.js>.
...
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | afterAddComment(comment) 								 Provides a notification when a new comment is added.                                                          |
|                     | constructor(artifactType, artifactLabel, commentContext, caseModel, documentTitle, docId, workItem) 								 Constructs a comment content pane. |
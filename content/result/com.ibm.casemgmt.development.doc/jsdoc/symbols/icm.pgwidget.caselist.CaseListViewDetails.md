...
# Class icm.pgwidget.caselist.CaseListViewDetails
...
Defined in:  <icm\pgwidget\caselist\CaseListViewDetails.js>.
...
|---------------------|-------------------------------------------------------------------------------------------------------------------------------|
|                     | getViewDecorator() 								 Returns the decorators of columns that are displayed in the details view of the Case List widget. |
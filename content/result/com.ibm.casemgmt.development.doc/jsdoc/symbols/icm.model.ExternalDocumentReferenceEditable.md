...
# Class icm.model.ExternalDocumentReferenceEditable
...
Defined in:  <icm\model\ExternalDocumentReferenceEditable.js>.

| Constructor Attributes   | Constructor Name and Description                                                                                        |
|--------------------------|-------------------------------------------------------------------------------------------------------------------------|
|                          | icm.model.ExternalDocumentReferenceEditable(properties) 							 Constructs an ExternalDocumentReferenceEditable object. |

| Method Attributes   | Method Name and Description                                                                                                                                                                                                                         |
|---------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | getProxyDocumentId() 								 Returns the proxy document id.                                                                                                                                                                                        |
...
|                     | retrieveJSON(callback, errback, backgroundRequest) 								 This method returns a JSON representation of this ExternalDocumentReferenceEditable object that can be used at the java API level to "rehydrate" an external document reference object. |
|                     | save(callback, errCallback, backgroundRequest) 								 Saves this ExternalDocumentReferenceEditable.                                                                                                                                               |

It is necessary to resolve some information with the mid-tier in order to generate this JSON
so this method takes a callback method.
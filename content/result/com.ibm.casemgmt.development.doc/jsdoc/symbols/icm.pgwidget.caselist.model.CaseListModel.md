...
# Class icm.pgwidget.caselist.model.CaseListModel

Defined in:  <icm\pgwidget\caselist\dijit\model\CaseListModel.js>.
...
|--------------------|-----------------------------------------------------------------------------|
|                    | cases  An array of icm.model.Case object representing the cases in the list |
|                    | caseType  Indicates if the search is cross case type search.                |

| Method Attributes   | Method Name and Description                                                                                                     |
|---------------------|---------------------------------------------------------------------------------------------------------------------------------|
|                     | buildCaseListGridModel(result) 								 Build the grid view structure and initialize the result set returned from a search.     |
|                     | constructor()                                                                                                                   |
|                     | destroy() 								 Clean up objects on destroy.                                                                                 |
|                     | getFormattedProperties(properties, item) 								 Get the HTML content to be displayed for a list of properties of a case item. |
|                     | getSortingPropertyList()                                                                                                        |
|                     | getSystemProperties() 								 Get the well-known properties.                                                                   |
|                     | onResultSetInitialized(resultSet, count, isRetrieveFirstPage)                                                                   |
|                     | onSearchCompleted(resultSet) 								 Event handler for seach template when query result is returned.                           |
|                     | setGridColumnWidth(gridColumnWidth) 								 Set the grid columns width to be used to render the result set.                    |
|                     | setSortingProperty(sortingProperty) 								 Set the sorting property's symbolic name for current search.                       |
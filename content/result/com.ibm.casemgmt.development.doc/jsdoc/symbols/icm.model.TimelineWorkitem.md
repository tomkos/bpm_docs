...
# Class icm.model.TimelineWorkitem
...
Defined in:  <icm\model\TimelineWorkitem.js>.

| Constructor Attributes   | Constructor Name and Description                                           |
|--------------------------|----------------------------------------------------------------------------|
|                          | icm.model.TimelineWorkitem() 							 Constructs a TimelineWorkitem object. |

| Field Attributes   | Field Name and Description                   |
|--------------------|----------------------------------------------|
|                    | entityName                                   |
|                    | firstEventTime  Time of the first event.     |
|                    | lastEventTime  Time of the last event.       |
|                    | status  step status.                         |
|                    | stepId  GUID of the step (workitem) instance |
|                    | taskId  GUID of the parent task.             |
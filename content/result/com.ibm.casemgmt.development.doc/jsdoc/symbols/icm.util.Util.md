...
|---------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | convertStagesSymNametoPrettyName(stagesArray, resultSet)                                                                                                     |
|                     | getBoxCollaborationRepository(caseModel) 								 Returns the Box repository that is specific for Box Collaboration that holds the server token information. |
|                     | getCaseHealthIcon(value)                                                                                                                                     |
|                     | getCaseHealthIconLg(value)                                                                                                                                   |
|                     | getExternalFolder(folderItem, caseContext, callback)                                                                                                         |
|                     | getExternalRepoId(serverName, externalRepositoryType, docId, domainId, templateId, vsId, callback)                                                           |
|                     | getRepositoryByName(name, domainId)                                                                                                                          |
| <static>            | icm.util.Util.getResourceBundle(section, solution) 								 Retrieves the resource bundle for a component.                                                   |
|                     | getResourceBundle(section, solution)                                                                                                                         |
|                     | getStagesDisplayName(slnObj)                                                                                                                                 |
|                     | getStagesDisplayNameasChoices(slnObj)                                                                                                                        |
|                     | getStagesForCaseTypeasChoices(caseObj)                                                                                                                       |
|                     | loadContent(url)                                                                                                                                             |
|                     | replaceLinksForMobile(str)                                                                                                                                   |
|                     | showErrDialogForMessage(messageKey)                                                                                                                          |
...
# Class icm.widget.menu.MenuManager

Represents the menu manager that manages all the menus in Case Manager Client.
				
				
					
Defined in:  <icm\widget\menu\MenuManager.js>.

| Constructor Attributes   | Constructor Name and Description                                                                                   |
|--------------------------|--------------------------------------------------------------------------------------------------------------------|
|                          | icm.widget.menu.MenuManager() 							 Constructs an object that that manages all the menus in Case Manager Client. |

| Method Attributes   | Method Name and Description                                                                                                                                   |
|---------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | destroyMenu(menu) 								 Destroys the specified menu.                                                                                                       |
|                     | refreshAnyPendingItems(async)                                                                                                                                 |
|                     | refreshMenus(widgetId, targetRef, useCache) 								 Refreshes the menu.                                                                                      |
|                     | setEnabled(actionId, widgetId, targetRef, enabled, cacheOnly) 								 Set the enabled attribute for the specified action in the specified widget.            |
|                     | setSelectedItems(widgetId, targetRef, selectedItems, actionContext, noRefresh) 								 Sets the selected items.                                              |
|                     | setTargetReference(menu, targetRef) 								 Sets the domNode to which the specified menu is attached as the target reference.                                |
|                     | setVisible(actionId, widgetId, targetRef, visible, cacheOnly, async) 								 Sets the visibility attribute for the specified action in the specified widget. |

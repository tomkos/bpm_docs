...
# Class icm.pgwidget.todolist.dijit.quicktask.QuickTaskAttachments

Class that represent the QuickTaskAttachments widget
				
				
					
Defined in:  <icm\pgwidget\todolist\dijit\quicktask\QuickTaskAttachments.js>.
...
|---------------------|-----------------------------------------------|
|                     | addAttachmentsToQT()                          |
|                     | addAttachmentsToWidget()                      |
|                     | cellSelected(item)                            |
|                     | cleanUpAttachmentDialog()                     |
|                     | createItemReference()                         |
|                     | destroy()                                     |
|                     | formatDate(rowObj, rowId)                     |
|                     | formatName(rowObj, rowId)                     |
|                     | getMimeClass(rowObj)                          |
|                     | initializeGrid(resultSet)                     |
|                     | moveAttachPressed(args)                       |
|                     | onResize()                                    |
|                     | postCreate()                                  |
|                     | previewAttachment(args)                       |
|                     | removePressed(args)                           |
|                     | render(response, qtDialog)                    |
|                     | rowsSelection(item)                           |
|                     | setAttachmentsfromResponse()                  |
|                     | setAttachmentsfromSelectedDoc(selectedItem)   |
|                     | toggleAttachmentLabel(attachmentBucket)       |
|                     | updateAttachmentsOnQTDialog(byPassBreadcrumb) |
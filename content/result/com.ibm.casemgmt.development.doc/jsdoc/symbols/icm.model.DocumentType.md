...
|--------------------------|------------------------------------------------------------------------------|
|                          | icm.model.DocumentType(properties) 							 Constructs a DocumentType object. |

| Field Attributes   | Field Name and Description                                                                                        |
|--------------------|-------------------------------------------------------------------------------------------------------------------|
|                    | description  The textual description of this document class                                                       |
|                    | instanceCreationRights  Indicates whether the user has the permission to create instances of this document class. |
|                    | itemTypeId  The item type ID if this DocumentType represents an item type, and null otherwise.                    |
|                    | solution  The solution this document class is in.                                                                 |
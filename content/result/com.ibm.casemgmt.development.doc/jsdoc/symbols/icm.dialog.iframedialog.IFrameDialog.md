...
# Class icm.dialog.iframedialog.IFrameDialog
...
Extends
				...
				Represents the dialog box in which an url can be rendered inside an iframe.
				
				
					
Defined in:  <icm\dialog\iframedialog\IFrameDialog.js>.

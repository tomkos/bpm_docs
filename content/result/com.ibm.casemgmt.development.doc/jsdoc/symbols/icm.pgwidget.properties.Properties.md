...
|                     | handleICM\_PageDeactivatedEvent() 								 Handler for icm.PageDeactivated event.              |
...
|                     | handleICM\_UpdatePropertiesEvent(payload) 								 Handler for the icm.UpdateProperties event. |

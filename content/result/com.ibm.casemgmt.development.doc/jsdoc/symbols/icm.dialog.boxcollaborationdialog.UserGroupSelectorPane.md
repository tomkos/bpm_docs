...
# Class icm.dialog.boxcollaborationdialog.UserGroupSelectorPane

Defined in:  <icm\dialog\boxcollaborationdialog\UserGroupSelectorPane.js>.
...
|--------------------|-------------------------------------------------------------------------|
|                    | removeAllAllowed  Set false to if last collaborator can not be removed. |
|                    | showDateAdded  Set true to display date added column in the grid.       |
|                    | showFilter  Set true to display filter control for the grid.            |

| Method Attributes   | Method Name and Description                                                                                                                                                                                                                                                                         |
|---------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | constructor()                                                                                                                                                                                                                                                                                       |
|                     | destroy() 								 Cleans up the widget                                                                                                                                                                                                                                                             |
|                     | getBoxFolderId() 								 Returns the current box folder id (processed because the boxFolder includes ICN's 'folder,' prefix which Box API doesn't use).                                                                                                                                            |
|                     | getBoxFolderName() 								 Returns the current box folder's name                                                                                                                                                                                                                                   |
|                     | getUpdatedContent()                                                                                                                                                                                                                                                                                 |
|                     | onChange() 								 Stub function for parent widget to connect for enable/disable save button                                                                                                                                                                                                       |
|                     | onPermissionChange(rowId, newValue) 								 Changes the permission for the collaborator.                                                                                                                                                                                                           |
|                     | onRemoveMember(rowId) 								 Removes the collaborator from the current grid.                                                                                                                                                                                                                      |
|                     | postCreate()                                                                                                                                                                                                                                                                                        |
|                     | resize()                                                                                                                                                                                                                                                                                            |
|                     | setContent(caseModel, membersList, boxFolderId, noRemoveBoxUId, callback) 								 Sets the content.                                                                                                                                                                                                |
|                     | showConfirmationOnUpdate(executeCallback, collaborator, executeCallback, cancelCallback) 								 Displays a confirmation dialog to let users decide if they are OK that the item being updated (or removed) was inherited and that the update or remove will be carried onto the parent folder(s). |
...
# Class icm.container.ICMSolutionSelectorPane

Defined in:  <icm\container\ICMSolutionSelectorPane.js>.
...
|                     | getMenuCallbackFunction()                                                                     |
|                     | getSelectedRole()                                                                             |
|                     | getSelectedSolution()                                                                         |
|                     | loadPages(solutions, solution, role)                                                          |
|                     | refreshTree()                                                                                 |
|                     | render()                                                                                      |
|                     | resetRoleMenus(solution, callback)                                                            |
|                     | selectNavigationItem(pagesCollectionId, itemType)                                             |
|                     | setContentPaneReference(contentPane)                                                          |
|                     | setSelectedRole(role)                                                                         |
|                     | setSelectedSolution(solution)                                                                 |
|                     | updateLabels(solution, role)                                                                  |
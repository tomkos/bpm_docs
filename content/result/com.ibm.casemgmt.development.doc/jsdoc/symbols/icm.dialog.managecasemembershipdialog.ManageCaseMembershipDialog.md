...
# Class icm.dialog.managecasemembershipdialog.ManageCaseMembershipDialog
...
Defined in:  <icm\dialog\managecasemembershipdialog\ManageCaseMembershipDialog.js>.
...
|--------------------|------------------------------------------------------------------------------------------------|
|                    | caseObject  The object referencing the case Loads the membership Set in the constructor's args |

| Method Attributes   | Method Name and Description                                                           |
|---------------------|---------------------------------------------------------------------------------------|
|                     | canEdit() 								 Membership can only be edited in two cases 1.                      |
|                     | constructor(args)                                                                     |
...
|                     | onSave()                                                                              |
|                     | postCreate()                                                                          |
|                     | show(applicationSpace, callback, showApplicationSpaceName) 								 Shows the dialog. |
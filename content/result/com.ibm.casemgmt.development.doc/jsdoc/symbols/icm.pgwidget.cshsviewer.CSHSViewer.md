...
# Class icm.pgwidget.cshsviewer.CSHSViewer

Class represents CSHSViewer widget
				
				
					
Defined in:  <icm\pgwidget\cshsviewer\CSHSViewer.js>.
...
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------------|
|                     | destroy() 								 destroy in case memory leak                                                                                            |
|                     | handleAddCaseCSHS(caseItem) 								 Handle Case CSHS to load                                                                             |
|                     | handleCaseDetailsCSHS(caseItem) 								 Handle Case CSHS to load                                                                         |
|                     | handleCaseInfo(caseItem) 								 Handle Case Information to render UI.                                                                   |
|                     | handleICM\_BeforeCancelEvent(context, complete, abort) 								 Handles pre cancel event from the coordination object.                     |
|                     | handleICM\_CaseSavedEvent(payload)                                                                                                         |
|                     | handleICM\_DisplayCSHSUrlEvent(payload) 								 Handler for icm.DisplayCSHSUrl event                                                      |
|                     | handleICM\_DisplayUrlEvent(payload) 								 Handler for icm.DisplayUrl event                                                              |
...
|                     | handleICM\_SendSplitCaseInfoEvent(payload) 								 Handler for the icm.SendSplitCaseInfo event which is received when user splits a case. |
|                     | handleICM\_StageRetrievedEvent(stages)                                                                                                     |
|                     | handleSolutionStaticCSHS()                                                                                                                |
|                     | handleSplitCaseCSHS(caseItem) 								 Handle Case CSHS to load for split case                                                            |
|                     | postCreate()                                                                                                                              |
|                     | resize()                                                                                                                                  |

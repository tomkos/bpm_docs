...
# Class icm.pgwidget.caseinfo.CaseInfoComponent

Defined in:  <icm\pgwidget\caseinfo\CaseInfoComponent.js>.
...
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------|
|                     | handleICM\_ClearContentEvent() 								 This event handler is used when the Case Information tab run as a stand-alone widget.        |
|                     | handleICM\_SelectCaseEvent(payload) 								 This event handler is used when the Case Information tab run as a stand-alone widget.   |
|                     | handleICM\_SendCaseInfoEvent(payload) 								 This event handler is used when the Case Information tab run as a stand-alone widget. |

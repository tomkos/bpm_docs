...
# Class icm.widget.dynamictaskeditor.flowsCommon.transform.FlowMaker

Defined in:  <icm\widget\dynamictaskeditor\flowsCommon\transform\FlowMaker.js>.
...
|---------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | addAndSplit(node, parentList)                                                                                                                              |
|                     | addCompoundStep(node, parentList)                                                                                                                          |
|                     | addGoto(node, parentList)                                                                                                                                  |
|                     | addOrSplit(node, parentList)                                                                                                                               |
|                     | addParametersToStep(step, node)                                                                                                                            |
|                     | addPropertiesToStep(step, node)                                                                                                                            |
|                     | addSplit(node, parentList, topLevelModel, legHandlingFunc)                                                                                                 |
|                     | addStep(node, parentList)                                                                                                                                  |
|                     | areMatching(joinId, splitId, isAndMatching)                                                                                                                |
|                     | buildDeadlineValue(node)                                                                                                                                   |
|                     | buildFlow(firstNode, parentList) 								 build a flow that starts from the firstNode, the flow elements are to be added as elements within the parentList |
|                     | buildNodeType(node)                                                                                                                                        |
|                     | constructor(args)                                                                                                                                          |
|                     | createTypedStep(node, mjp)                                                                                                                                 |
|                     | doneCurrentAndSplitProcessing()                                                                                                                            |
|                     | doneCurrentOrSplitProcessing()                                                                                                                             |
|                     | getCurrentAndSplit()                                                                                                                                       |
|                     | getCurrentOrSplit()                                                                                                                                        |
|                     | handleAndSplitLeg(incomingRoute, parentList)                                                                                                               |
|                     | handleOrSplitLeg(incomingRoute, parentList)                                                                                                                |
|                     | isAndJoin(nodeId)                                                                                                                                          |
|                     | isDummyAndSplit(node)                                                                                                                                      |
|                     | isGotoJoinForCurrentSplit(joinId)                                                                                                                          |
|                     | isGotoJoinOfSplit(joinId, splitId)                                                                                                                         |
|                     | isJoinForCurrentAndSplit(id)                                                                                                                               |
|                     | isJoinForCurrentOrSplit(id)                                                                                                                                |
|                     | isOrJoin(nodeId)                                                                                                                                           |
|                     | needsExitPoint(node)                                                                                                                                       |
|                     | setupWaitForElement(waitElement, node)                                                                                                                     |
|                     | setupWaitUntilElement(waitElement, node)                                                                                                                   |
|                     | startAndSplitProcessing(andSplit)                                                                                                                          |
|                     | startOrSplitProcessing(orSplit)                                                                                                                            |
|                     | transformMapJsonToFlow()                                                                                                                                   |
...
# Class icm.action.document.ViewLink
...
Extends
				...
				Generates a document URL link and show in dialog. It "inherits" from the ShowHyperLink action in ICN. 

       Context required by this action: ['Document'] 

Defined in:  <icm\action\document\ViewLink.js>.

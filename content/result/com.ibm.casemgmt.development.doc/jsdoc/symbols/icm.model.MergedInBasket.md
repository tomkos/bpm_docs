...
# Class icm.model.MergedInBasket

Extends
					ecm.model.Item, ecm.LoggerMixin.

				
			
				Represents an in-basket for merged work list.
				
				
					
Defined in:  <icm\model\MergedInbasket.js>.

| Constructor Attributes   | Constructor Name and Description                            |
|--------------------------|-------------------------------------------------------------|
|                          | icm.model.MergedInBasket() 							 Development in-progress. |

| Method Attributes   | Method Name and Description                                                                                                            |
|---------------------|----------------------------------------------------------------------------------------------------------------------------------------|
|                     | constructor()                                                                                                                          |
|                     | retrieveFilterCriteria(callback)                                                                                                       |
|                     | retrieveFolderContents(flag, callback, orderBy, descending, refresh, teamspace)                                                        |
|                     | retrieveNextPage(rs, itemsNeeded, callBack)                                                                                            |
|                     | retrieveWorkItems(callback, orderBy, descending, refresh, filters, queryFilter, substitutionVars, queryFlags, bpmVars, notSortClicked) |

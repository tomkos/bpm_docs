...
Select which method to use to configure your profiles,
databases, and network deployment environment. You can use either the BPMConfig
command-line utility or multiple tools (deprecated) to complete the profile and deployment
environment setup.

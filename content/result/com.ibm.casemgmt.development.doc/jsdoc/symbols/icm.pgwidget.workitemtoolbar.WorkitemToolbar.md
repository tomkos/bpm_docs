...
|                     | postCreate()                                                                                             |
|                     | startup()                                                                                                |
|                     | updateCurrentViewPane() 								 update the contentPane UI according to the settings for the page widget |
|                     | updateModel(model) 								 update the model according to the settings for the page widget               |

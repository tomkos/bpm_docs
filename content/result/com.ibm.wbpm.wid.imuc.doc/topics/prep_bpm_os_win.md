...
If you are planning to use Db2 Express with your Business Automation Workflow installation, the user
account must have administrative privileges (Administrator) on the machine where you install.

## About this task

Because WebSphere®
Application Server is a prerequisite of the
Business Automation Workflow test
environment, you must complete all preparation tasks for WebSphere
Application Server before installing
Business Automation Workflow if you plan to
...
before installing IBM Integration
Designer:

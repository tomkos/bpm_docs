...
|--------------------------|-----------------------------------------------------------------------------------------------------------------------------|
|                          | icm.dialog.dynamictaskeditor.DynamicTaskEditorDialog() 							 Constructs an instance of the Custom Task Editor dialog box. |
...
|                     | hide()                                                                                                              |
|                     | onCancel()                                                                                                          |
| <static>            | icm.dialog.dynamictaskeditor.DynamicTaskEditorDialog.open(payload) 								 Open the Custom Task Editor dialog box. |
|                     | postCreate()                                                                                                        |
|                     | resize(coords)                                                                                                      |
|                     | showDialog(payload) 								 Shows the Custom Task Editor dialog box.                                               |

...
This is a very basic illustration of the definitions part of a rule. For more information about
complex versions of the definition part, such as multiple occurrences of a value, or adding a
where clause to a definition to apply further restrictions on the variables,
refer to the related section in the IBM® Operational Decision
Manager documentation, "BAL constructs -- definitions." A related link
is provided.

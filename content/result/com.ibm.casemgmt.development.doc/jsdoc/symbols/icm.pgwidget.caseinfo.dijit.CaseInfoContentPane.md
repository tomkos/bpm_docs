...
# Class icm.pgwidget.caseinfo.dijit.CaseInfoContentPane

Defined in:  <icm\pgwidget\caseinfo\dijit\CaseInfoContentPane.js>.

| Constructor Attributes   | Constructor Name and Description                                                                                                                           |
|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                          | icm.pgwidget.caseinfo.dijit.CaseInfoContentPane() 							 This is the main UI widget that displays the different tabs - Summary, Documents, Tasks, History |

| Field Attributes   | Field Name and Description                          |
|--------------------|-----------------------------------------------------|
|                    | tabDefinitions  Tabs to be displayed in the widgets |
...
|                     | destroy()                                                                                      |
|                     | destroyRecursive()                                                                             |
|                     | getChildWidgets() 								 Return all children dijit on Tab                                    |
|                     | getTab(tabName) 								 Return specified tab in the TabContainer tabName is the definitionId. |
|                     | linked(childIndex)                                                                             |
|                     | onClickOpenCaseDetails()                                                                       |
|                     | onClickTab(tab) 								 Event fired when a tab is selected                                    |
|                     | onResize()                                                                                     |
|                     | postCreate()                                                                                   |
|                     | render()                                                                                       |
|                     | resize(size)                                                                                   |
|                     | savePosition(e)                                                                                |
|                     | setModel(model) 								 Sets the model on the Case Information widget                         |
|                     | setTabDefinitions(tabDefinitions) 								 Sets the tab definitions for the widget             |
|                     | showHideCaseInfoHeader()                                                                       |
|                     | startup()                                                                                      |
|                     | touchScroll(e)                                                                                 |
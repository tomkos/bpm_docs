...
|---------------------|--------------------------------------------------------------------------------------------------------------------|
|                     | retrieveAttachmentValues(callback) 								 Retrieves the attachment property values for a work item model object. |

To improve performance, the values associated with icm.model.properties.controller.types.AttachmentPropertyController
objects are not initially retrieved. Any code interested in accessing attachment
property values must first call this method to ensure they are retrieved.
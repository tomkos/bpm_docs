...
# Class icm.action.stage.ToggleOnHoldStage

Extends
					icm.action.CaseAction.

				
			
				Complete the current stage.

       Context required by this action: ['Case', 'CaseStage'] 

Defined in:  <icm\action\stage\ToggleOnHoldStage.js>.

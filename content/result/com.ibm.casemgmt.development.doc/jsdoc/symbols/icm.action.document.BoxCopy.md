...
# Class icm.action.document.BoxCopy
...
Extends
				...
				Copies the selected document(s) to or from an existing Box Collaboration Folder. Supported only for P8 and Box repositories.

       Context required by this action: ['Document'] , ['Case'], ['CurrentFolder']

Defined in:  <icm\action\document\BoxCopy.js>.
...
|---------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | execute()                                                                                                                                                                                                                                                        |
|                     | isEnabled() 								 For copy to be enabled, ICN Box Copy option needs to be enabled on P8 repository, a Box Collaboration folder must be created in the case and all selected items need to be P8 Case or Box documents - no folders and no external documents. |
|                     | isVisible()                                                                                                                                                                                                                                                      |
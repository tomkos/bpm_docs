...
# Class icm.action.workitem.ReturnToSender
...
Extends
				...
				Returns a work item to the in-basket it was most recently in. If the work item is open, this action first 
       closes the work item.

       Context required by this action: [['WorkItem', 'Solution']]

Defined in:  <icm\action\workitem\ReturnToSender.js>.

...
administer process applications and toolkits that are developed in Process Designer. You can create more than one deployment
...
Type section, select Standard Workflow Center. Features

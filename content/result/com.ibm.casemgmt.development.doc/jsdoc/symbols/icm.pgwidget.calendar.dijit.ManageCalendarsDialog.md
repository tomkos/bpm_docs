...
# Class icm.pgwidget.calendar.dijit.ManageCalendarsDialog

Represents the Show Calendar dialog box.
				
				
					
Defined in:  <icm\pgwidget\calendar\dijit\ManageCalendarsDialog.js>.
...
|---------------------|--------------------------------------------------------------------------------|
|                     | addCalendarTypeToGrid(subscription)                                            |
|                     | constructor() 								 Constructs an instance of the Show Calendar dialog box. |
|                     | onCancel()                                                                     |
|                     | populateSubscriptionData(subscription)                                         |
|                     | resetHandlers()                                                                |
|                     | resize()                                                                       |
|                     | showDialog()                                                                   |
|                     | updateSelectedCalendarTypes(calendarType)                                      |
...
# Class icm.pgwidget.casevisualizer.snapshot.dijit.SnapshotRuler

Defined in:  <icm\pgwidget\casevisualizer\snapshot\dijit\SnapshotRuler.js>.
...
|---------------------|------------------------------------------------------------------|
|                     | clear() 								 Clears the elements from the canvas             |
|                     | constructor(driver)                                              |
|                     | destroy()                                                        |
|                     | init(container, width, height)                                   |
|                     | layout()                                                         |
|                     | render(startTime, endTime, shortFormat) 								 Render the rule |
|                     | toggleTimeScrubber(enabled)                                      |
|                     | updateScales(startTime, endTime)                                 |
|                     | updateScrubber(origin, time)                                     |
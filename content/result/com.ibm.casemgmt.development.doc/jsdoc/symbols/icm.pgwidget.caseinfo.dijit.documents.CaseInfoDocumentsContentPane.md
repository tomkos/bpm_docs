...
# Class icm.pgwidget.caseinfo.dijit.documents.CaseInfoDocumentsContentPane
...
Defined in:  <icm\pgwidget\caseinfo\dijit\documents\CaseInfoDocumentsContentPane.js>.
...
|---------------------|-----------------------------------------------------------------------------------------------------------------------|
|                     | allDocsInViewSelected(gridResultSet)                                                                                  |
|                     | bExternalDocSupport()                                                                                                 |
|                     | constructor(param)                                                                                                    |
|                     | destroy()                                                                                                             |
|                     | fileDoc(selectedDoc) 								 Called to file the selected document into the current folder.                           |
|                     | getCallback(actionId) 								 Called to provide a callback function if the action is a "select document" action.     |
|                     | getDetailedCustomColunns()                                                                                            |
|                     | getMagCustomColumns()                                                                                                 |
|                     | handleSelectInitialFolder(subFolderPath) 								 Called to open the sub-folder within the case and show its content. |
|                     | indexOfItem(itemList, itemId)                                                                                         |
|                     | isInFocus()                                                                                                           |
|                     | isSelectedForSplitCase(selectedItem)                                                                                  |
|                     | onClbCommentCountMagazineViewStructure(column)                                                                        |
|                     | onClbDownloadCountMagazineViewStructure(column)                                                                       |
|                     | onClbRecommendationCountMagazineViewStructure(column)                                                                 |
|                     | onClbTagsMagazineViewStructure(column)                                                                                |
|                     | onContentMagazineViewStructure(column)                                                                                |
|                     | onRender() 								 Event fired when grid finish loading.                                                             |
|                     | onSelectItem() 								 Event fired when a document or folder is selected                                             |
|                     | postCreate()                                                                                                          |
|                     | refreshCheckbox()                                                                                                     |
|                     | render(model) 								 Called to render documents and folders to be retrieved from the given model.                   |
|                     | resize()                                                                                                              |
|                     | stopScroll(e)                                                                                                         |
|                     | switchCheckAll()                                                                                                      |
|                     | updateMimeTypes()                                                                                                     |

...
| JspLocation             | getJspLocation(JspUsageEnum usage) Returns the JSP location for a given usage pattern.                                                                                                      |

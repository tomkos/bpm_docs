...
# Class icm.pgwidget.calendar.Calendar

Extends
					icm.pgwidget.calendar.dijit.CalendarContentPane, icm.base.BasePageWidget.

Defined in:  <icm\pgwidget\calendar\Calendar.js>.

| Constructor Attributes   | Constructor Name and Description                         |
|--------------------------|----------------------------------------------------------|
|                          | icm.pgwidget.calendar.Calendar() 							 Calendar Widget |
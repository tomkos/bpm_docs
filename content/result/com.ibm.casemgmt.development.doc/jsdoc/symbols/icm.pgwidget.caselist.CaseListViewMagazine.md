...
# Class icm.pgwidget.caselist.CaseListViewMagazine
...
Defined in:  <icm\pgwidget\caselist\CaseListViewMagazine.js>.
...
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------|
|                     | getViewDecorator() 								 Returns the decorator of the cell value that is displayed in the magazine view of the Case List widget. |
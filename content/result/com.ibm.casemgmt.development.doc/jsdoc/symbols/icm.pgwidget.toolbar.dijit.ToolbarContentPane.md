...
# Class icm.pgwidget.toolbar.dijit.ToolbarContentPane

Defined in:  <icm\pgwidget\toolbar\dijit\ToolbarContentPane.js>.
...
|---------------------|------------------------------------------------------------------------------------------------------------|
|                     | buildToolbar() 								 build a Toolbar digit into the contentPane and destroying the existing one if have |
|                     | constructor()                                                                                              |

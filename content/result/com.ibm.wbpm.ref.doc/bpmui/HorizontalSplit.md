...
| Height:          | Optional - Default at 100% of its container (but container must have explicitly set height)   | String          |
|------------------|-----------------------------------------------------------------------------------------------|-----------------|
| Pane specs:      | Specify various appearance variables for each pane, such as width, handle location, etc.      | SplitPaneSpec[] |
| Resizable panes: | Allow the panes to be resized by dragging the edges horizontally.                             | Boolean         |

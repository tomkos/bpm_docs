...
# Class icm.pgwidget.caseform.CaseFormContentPane

Defined in:  <icm\pgwidget\caseform\CaseFormContentPane.js>.
...
|---------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | adjustCaseMode(forceEditMode) 								 This method adjusts the mode to "editCase" if the current mode is "viewCase" and the form data is invalid or otherwise directed.          |
|                     | deletePosition(e)                                                                                                                                                                |
|                     | getFieldValue(name)                                                                                                                                                              |
|                     | getWidgetSize() 								 This private method obtains the current size of the widget body node as a hack for working around the invalid values passed by the onSizeChanged event. |
|                     | inject(fieldData, forceEditMode)                                                                                                                                                 |
|                     | isDirty()                                                                                                                                                                        |
|                     | persist(formReference, folderReference, title, timeZone)                                                                                                                         |
|                     | postCreate()                                                                                                                                                                     |
|                     | resizeDijit(dim)                                                                                                                                                                 |
|                     | savePosition(e)                                                                                                                                                                  |
|                     | setDirty(dirty)                                                                                                                                                                  |
|                     | setMode(mode) 								 This method unconditionally sets the mode as specified.                                                                                                   |
|                     | setReadOnly(readOnly)                                                                                                                                                            |
|                     | touchScroll(e)                                                                                                                                                                   |
|                     | updateMode() 								 This method updates the mode only if the next mode is different from the current mode.                                                                     |
|                     | validate(callback)                                                                                                                                                               |
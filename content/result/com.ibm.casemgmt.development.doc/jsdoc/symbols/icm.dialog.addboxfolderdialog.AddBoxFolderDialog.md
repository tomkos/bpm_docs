...
# Class icm.dialog.addboxfolderdialog.AddBoxFolderDialog
...
Extends
				...
				Represents the dialog for AddBoxCollaborationFolder action. Use this dialog to create a Box collaboration folder and optionally invite collaborators.
				
				
					
Defined in:  <icm\dialog\boxcollaborationdialog\AddBoxFolderDialog.js>.
...
|---------------------|-----------------------------------------------------------------------------------------------------------------|
|                     | constructor()                                                                                                   |
|                     | hideInvitePane() 								 Hides the invite user pane                                                            |
|                     | onCreate() 								 Callback when user selects Create button.                                                   |
|                     | postCreate()                                                                                                    |
|                     | showDialog(caseModel, folderName, callback) 								 Displays the dialog for adding a Box collaboration folder. |
|                     | showInvitePane() 								 Displays the invite user pane                                                         |
...
# Class icm.container.ICMPagesCollection

Defined in:  <icm\container\ICMPagesCollection.js>.

| Constructor Attributes   | Constructor Name and Description                                             |
|--------------------------|------------------------------------------------------------------------------|
|                          | icm.container.ICMPagesCollection(pagesTabContainer, id, solutionRoleContext) |

| Method Attributes   | Method Name and Description                                                                                                                                       |
|---------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                     | createDynamicPage(pageClass, pageType, crossPageEventName, crossPageEventPayload, subject, pageTitle, pageContext, callback, isLazy) 								 Open a dynamic page |
|                     | createLazyPage(pageClass, pageType, callback, subject, pageTitle, pageContext, layoutName, layoutCSHSName)                                                        |
|                     | createPage(pageClass, pageType, callback, subject, pageTitle, pageContext, tabOrder, layoutName, layoutCSHSName) 								 Ceate a page instance                   |
|                     | createWelcomePage(solution)                                                                                                                                       |
|                     | destroy()                                                                                                                                                         |
|                     | destroyPage(pageId)                                                                                                                                               |
|                     | destroyPages()                                                                                                                                                    |
|                     | getFirstStaticPage()                                                                                                                                              |
|                     | getId()                                                                                                                                                           |
|                     | getPage(pageId)                                                                                                                                                   |
|                     | getStaticPageByPageClass(pageClass)                                                                                                                               |
|                     | handleICM\_BroadcastToAllPagesEvent(payload)                                                                                                                       |
|                     | handleICM\_ClosePageWithPageIdEvent(payload)                                                                                                                       |
|                     | handleICM\_OpenPageEvent(payload)                                                                                                                                  |
|                     | isCollectionDirty()                                                                                                                                               |
|                     | selectPage(page)                                                                                                                                                  |
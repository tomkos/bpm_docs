...
# Class icm.model.\_AttributeDefinitionMixin

This class is mixed in to the navigator AttributeDefinition object.
       This class provides some ICM specific attribute on the AttributeDefinition object.
				
				
					
Defined in:  <icm\model\_AttributeDefinitionMixin.js>.

| Constructor Attributes   | Constructor Name and Description                                                                |
|--------------------------|-------------------------------------------------------------------------------------------------|
|                          | icm.model.\_AttributeDefinitionMixin() 							 Constructs the attribute definition mixin object. |

| Field Attributes   | Field Name and Description                                                                                                              |
|--------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
|                    | customInvalidItems  The custom invalid items for this attribute definition.                                                             |
|                    | customValidationError  The custom validation error for this attribute definition.                                                       |
|                    | displayMode  The display mode for this attribute definition.                                                                            |
|                    | externalDataModifications  Indicates what settings of this attribute definition have been modified by an external data service, if any. |
|                    | inheritedAttribute  Boolean indicating whether this attribute definition is inherited or not.                                           |
|                    | provider  The provider for this attribute definition.                                                                                   |
|                    | symbolicName  The symbolicName for this attribute definition.                                                                           |

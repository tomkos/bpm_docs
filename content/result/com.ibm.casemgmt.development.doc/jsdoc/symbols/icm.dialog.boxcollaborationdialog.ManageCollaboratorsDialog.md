...
# Class icm.dialog.boxcollaborationdialog.ManageCollaboratorsDialog

Defined in:  <icm\dialog\boxcollaborationdialog\ManageCollaboratorsDialog.js>.
...
|                     | postCreate()                                                                                |
|                     | resize()                                                                                    |
|                     | show(membersList, callback, boxFolder, boxLoginUserId, callback) 								 Shows the dialog. |
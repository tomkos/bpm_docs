...
# Class icm.action.folder.SendBoxCollaborators
...
Defined in:  <icm\action\folder\SendBoxCollaborators.js>.
...
|                     | isEnabled()                                                  |
|                     | isVisible()                                                  |
|                     | onInvite(boxFolder, selectedUsers, requestMessage, deadline) |
...
Extends
					dijit/\_Widget, dijit/\_Templated, ecm/LoggerMixin.
...
|--------------------------|----------------------------------------------------------------|
|                          | icm.widget.menu.Menu() 							 Constructs a menu or a toolbar. |

| Method Attributes   | Method Name and Description                                                                                 |
|---------------------|-------------------------------------------------------------------------------------------------------------|
|                     | build(callback) 								 Builds the menu or toolbar.                                                        |
|                     | constructor()                                                                                               |
|                     | getContextObject(ctxobj) 								 Gets the context object that is to be used in the menu or toolbar.        |
|                     | getId() 								 Gets the identifier of the menu or toolbar.                                                |
|                     | isContextualMenu() 								 True if the menu instance is a contextualMenu                                   |
|                     | isEnabled(action) 								 Determines whether the specified action is enabled.                              |
|                     | isGlobalAction(action) 								 Determines whether the specified action is global.                          |
|                     | isMultipleAction(action) 								 Determines whether the specified action is applicable for multiple items. |
|                     | isSingleAction(action) 								 Determines whether the specified action is applicable for single item.      |
|                     | isToolbar() 								 True if the menu instance is a toolbar                                                 |
|                     | isVisible(action) 								 Determines whether the specified action is visible.                              |
|                     | performAction(action, e) 								 Performs the specified action.                                            |
|                     | postCreate()                                                                                                |
|                     | setActionParameterMap(action) 								 Sets the parameter map for the specified action.                     |
|                     | setContextObject(ctxobj) 								 Set the context object to be used in the menu.                            |
|                     | startup()                                                                                                   |
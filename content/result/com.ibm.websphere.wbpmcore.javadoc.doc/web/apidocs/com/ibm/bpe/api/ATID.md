...
Interface for an activity template object identifier.
 ...
 An activity template object identifier uniquely identifies an activity.
 It is created when the activity template is created and stays with the activity template
 during its lifetime.
Since:
5.0

...
Use the BPMArchiveToolkit command
in connected mode to archive a deactivated toolkit. You can run this
command only on Workflow Center.

The BPMArchiveToolkit command
...
wsadmin>AdminTask.BPMArchiveToolkit('[-containerAcronym MYCOTK]')
```
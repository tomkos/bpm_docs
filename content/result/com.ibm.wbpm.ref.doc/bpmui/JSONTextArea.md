...
|-----------------------|-----------------------------------------------------------------|----------|
| Disable pretty print: | Disable pretty printing for the specified JSON object literals. | Boolean  |
...
| Name   | Type     | Default   | Description                  |
|--------|----------|-----------|------------------------------|
| label  | {string} |           | label for the JSON text area |
...
| Name   | Type      | Default   | Description                              |
|--------|-----------|-----------|------------------------------------------|
| flag   | {boolean} |           | set the visibility of the JSON text area |
...
| Name   | Type     | Default   | Description                    |
|--------|----------|-----------|--------------------------------|
| text   | {string} |           | the text in the JSON text area |

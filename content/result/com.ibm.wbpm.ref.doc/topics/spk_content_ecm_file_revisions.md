...
The appearance
configuration properties for the ECM File Revisions view are shown in the following table:
...
The content management advanced configuration properties for the ECM File Revisions view
...
example:console.log(me.getVersionCount())
...
For detailed information on the available methods for ECM File Revisions, see the ECM File Revisions JavaScript
API.

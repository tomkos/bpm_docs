...
```
configmgr\_cl exportSolutionAuditManifest -profile myDevelop1 
 -manifestNames Audit1 
 -manifestPackage "C:\Program Files (x86)\IBM\CaseManagement\solution\_packages\Audit1.zip"
 -solutionName MySolution
```

```
configmgr\_cl exportSolutionAuditManifest -help
```